...
gantt
    ...
    axisFormat %d
    %% 下の axisFormat で日付ではなく「経過日数」のように見せます

    section 一般的なアジャイル
    定義・見積もり       :done, a1, 2024-01-01, 3d
    実装・テスト         :active, a2, after a1, 6d
    レビュー・修正       :a3, after a2, 3d

    section AIエージェント開発
    課題の棚卸し          :crit, b1, 2024-01-01, 3d
    実装 (生成)          :b2, after b1, 1d
    レビュー・調整       :b3, after b2, 2d
    レビュー・調整       :b4, after b3, 2d
    レビュー・調整       :b5, after b4, 2d
    レビュー・調整       :b6, after b5, 2d
```
